...
class PGForm
{
                ...
                case $tag == 'select':
                    if ($input->getAttribute('multiple')) {
                        ...
                        if ($selected = $this->page->xpath->query('.//option[@selected]', $input)->item(0)) {
                            ...
                            if ($option = $this->page->xpath->query('.//option[@value]', $input)->item(0)) {
     ...
     */
    public function submit($headers = [])
    {
        ...
        switch ($this->method) {
            ...
            case 'post':
                if ('multipart/form-data' == $this->enctype) {
                    ...
                    return $this->browser->post($this->action, $this->fields, []);
                }
            ...
            default:
                echo "Unknown form method: $this->method\n";
        }
